...
const Home: React.FC = () => {
  ...
  const performance_img5 = '/performance_img1.svg';
  const performance_img6 = '/performance_img2.svg';
  const performance_img7 = '/performance_img3.svg';
  const performance_img8 = '/performance_img4.svg';
